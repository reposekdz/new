...
import { X, Settings, Cpu, Type, Save, TerminalSquare } from 'lucide-react';
...
const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose, settings, onUpdateSettings }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="w-full max-w-md bg-[#09090b] border border-zinc-800 rounded-xl shadow-2xl overflow-hidden scale-100">
        {/* Header */}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-xs font-medium text-zinc-400 uppercase tracking-wide">Project Name</label>
            <input 
              type="text" 
             ...
             <div className="grid grid-cols-1 gap-2">
                ...
                >
                    <div>
                        ...
                        <div className="text-[10px] opacity-70">Optimized for speed & latency</div>
                    </div>
                ...
                >
                    <div>
                        ...
                        <div className="text-[10px] opacity-70">High-reasoning & architecture</div>
                    </div>
